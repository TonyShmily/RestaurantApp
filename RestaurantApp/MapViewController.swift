...
class MapViewController: UIViewController,MKMapViewDelegate {
    ...
    func mapView(mapView: MKMapView, viewForAnnotation annotation: MKAnnotation) -> MKAnnotationView? {        let id = "我的图钉"
        ...
        annotationView?.pinTintColor = UIColor(red: 242/255, green: 116/255, blue: 119/255, alpha: 100/100)
